...
<div class="container-fluid">
	<div class="row">
		<h2 id="intro" class="col-xs-12 text-center"><?php echo $title; ?></h2>
	</div>
</div>
...
<div class="container-fluid" id="galerie-filmstrip">
	<div class="row">
		<div id="galerie-thumb-bro" class="col-xs-2 galerie-thumb"><div class="galerie-thumb-scroll groupToMatch">
			<?php foreach ($versions as $idx => $version) : ?>
				<div class=""><a href="#" class="thumbnail"  data-target="#GalerieCarousel" data-slide-to="<?php echo $idx; ?>"><?php 
		...
		<div class="col-xs-8 galerie-carousel groupToMatch">
			<!-- Carousel
			    ================================================== -->
		...
		<div id="galerie-thumb-child" class="col-xs-2 galerie-thumb">
...
<div class="container-fluid" id="galerie-info">
	<div class="col-xs-12 galerie-carousel groupToMatch">
			<!-- Carousel
			    ================================================== -->
					  	...
					  	<?php foreach ($versions as $idx => &$version) : ?>
					  		<div class="<?php echo $idx?'item':'item active'; ?>">
					  			...
					  			<div class="row">
									...
									<div class="col-xs-8 text-center"> <h2 id="versionTitle"><?php 
								...
								<?php if(AuthComponent::user() && AuthComponent::user()['role'] === 'admin'):?>
									...
									<div class="row">
										...
										<!-- Form Name -->
										<h2 class="text-center"><?php echo __('Configuration de la galerie');?></h2>
